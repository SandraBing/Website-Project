...
<td>Property:</td><td><input type="text" name="address1" value="<?php echo
$address1; ?>"/></td>
</tr>
...
<tr>
<td>Description: </td><td><textarea name="shortdescription" rows="8" cols="35"><?php echo $shortdescription;
?></textarea></td>
</tr>
<tr>
<td>Further Details: </td> <td><textarea name="longdescription" rows="8" cols="35"><?php echo
$longdescription; ?></textarea></td>
</tr>
<tr>
<td>Vendor Email: </td>
<td>
...
<select name="category" required="required">
 <?php
echo "<option value = '$propertyid'>$categoryname</option>"; //display the current value at the top
